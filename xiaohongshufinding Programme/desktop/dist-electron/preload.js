...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  selectHistoryDirectory: () => electron.ipcRenderer.invoke("select-history-directory"),
  shellOpenPath: (targetPath) => electron.ipcRenderer.invoke("shell-open-path", targetPath)
});
